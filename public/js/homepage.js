...
const banishFormEl = document.querySelector("#banish-form");
...
const banishFormHandler = function() {
    event.preventDefault();
    // console.log(banishFormEl.input.value);
};

// hostGameBtn.addEventListener("click", hostGameBtnHandler);
// joinGameBtn.addEventListener("click", joinGameHandler);
banishFormEl.addEventListener("submit", banishFormHandler);